...
opt_install () {
        ...
        if [ $? == 0 ]
                ...
                then
                        ...
                        echo "alias adb-xb='cd $PWD && sudo bash ADB-XB.sh'" >> ~/.bash_aliases
                        source ~/.bash_aliases
                        echo -e "\n\e[1;92mINSTALLATION COMPLETED\n"
                        echo -e "\e[1;92mUSAGE = \e[1;91m'sudo ./ADB-XB.sh' or you can do 'sudo adb-xb' from anywhere in shell\e[0m\n\n"|lolcat
                        sleep 5
                        clear
                        echo -e "DONE"|lolcat
                        sleep 3
